...
-- -----------------------------------------------------
-- Schema wineManagerTests
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema wineManagerTests
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `wineManagerTests` DEFAULT CHARACTER SET utf8 ;
USE `wineManagerTests` ;

-- -----------------------------------------------------
-- Table `wineManagerTests`.`colors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`colors` (
...
-- -----------------------------------------------------
-- Table `wineManagerTests`.`countries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`countries` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `wineManagerTests`.`manufacturers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`manufacturers` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_manufacturers_countries`
    ...
    REFERENCES `wineManagerTests`.`countries` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wineManagerTests`.`storageboxes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`storageboxes` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `wineManagerTests`.`wines`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`wines` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_wines_colors1`
    ...
    REFERENCES `wineManagerTests`.`colors` (`id`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_wines_manufacturers1`
    FOREIGN KEY (`manufacturer_id`)
    REFERENCES `wineManagerTests`.`manufacturers` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_wines_storageboxes1`
    FOREIGN KEY (`storagebox_id`)
    REFERENCES `wineManagerTests`.`storageboxes` (`id`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wineManagerTests`.`alerts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`alerts` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `wineManagerTests`.`grapeVarieties`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`grapeVarieties` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `wineManagerTests`.`logs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`logs` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_logs_wines1`
    FOREIGN KEY (`wine_id`)
    REFERENCES `wineManagerTests`.`wines` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wineManagerTests`.`wines_has_grapeVarieties`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`wines_has_grapeVarieties` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_wines_has_grapeVarieties_grapeVarieties1`
    ...
    REFERENCES `wineManagerTests`.`grapeVarieties` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wineManagerTests`.`wines_has_storageboxes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`wines_has_storageboxes` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `wine_id` INT NOT NULL,
  `storagebox_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `wineManagerTests`.`wines_has_alerts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wineManagerTests`.`wines_has_alerts` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_wines_has_alerts_alerts1`
    ...
    REFERENCES `wineManagerTests`.`alerts` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
